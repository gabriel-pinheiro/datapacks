...
execute as @e[tag=warp_portals.wand] at @s if entity @e[tag=warp_portals.portal,distance=..3] run function warp_portals:error/portal_too_close
execute as @e[tag=warp_portals.wand] at @s run function warp_portals:create/check_too_far
