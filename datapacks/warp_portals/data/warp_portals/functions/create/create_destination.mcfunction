...
execute as @s store result score @p warp_portals.portal_create_x run data get entity @s Pos[0] 1
execute as @s store result score @p warp_portals.portal_create_y run data get entity @s Pos[1] 1
execute as @s store result score @p warp_portals.portal_create_z run data get entity @s Pos[2] 1
