...
summon item ~ ~ ~ {Item:{id:"minecraft:shulker_spawn_egg",Count:1b,tag:{display:{Name:'{"text":"Portal Wand","italic":false}'},CustomModelData:105001,Enchantments:[{}],EntityTag:{Silent:1b,CustomNameVisible:0b,NoAI:1b,AttachFace:0b}}}}
